    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-30">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6 text-[#545454]">
                ...
                <button onClick={() => { navigate('/products'); scrollTo(0, 0) }} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <img className="group-hover:-translate-x-1 transition h-[15px] w-[15px]" src={assets.arrow_right_icon_colored} alt="arrow" />
                    Continue Shopping
                </button>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                <h2 className="text-xl md:text-xl font-medium text-[#545454]">Order Summary</h2>
